...
export default function Video() {
  ...
  const { myEmail, myName, emailToSocket, socketToEmail } = useSelector(
    (state) => state.userInfo
  );
  console.log('myInfo: ', myEmail, myName);
  ...
  useEffect(() => {
    ...
    navigator.mediaDevices
      ...
      .then((stream) => {
        ...
        socketRef.current.emit('join room', { roomID, myEmail });
                  ...
                  >
                    <Box>
                      ...
                      >
                        <Typography variant="h7" component="div">
                          {
                            // emailToSocket[socketToEmail[vidList[index]]]
                            //   .userName
                            vidList[index]
                          }
                        </Typography>
